...
public final class BlackCastle extends NonLoadableObject {
  ...
  public BlackCastle(float x, float y) {
    
    this.id = "BlackCastle";
    
    this.texture = new Texture(Gdx.files.internal("images/BlackCastle.png"));
